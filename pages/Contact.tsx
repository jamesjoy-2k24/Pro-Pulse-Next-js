...
const ContactUs = () => {
  async function handleSubmit(e: {
    ...
    const response = await fetch('https://api.web3forms.com/submit', {
      ...
      body: JSON.stringify({
        access_key: '3e49b032-7455-4968-a44e-ae2d6f9d3567',
        ...
        <div className="grid md:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-6xl bg-white shadow-md shadow-purple-500  rounded-md text-[#333] ">
              ...
              <ul className="mt-3">
                <li className="flex items-center">
                  ...
                  <a
                    ...
                    className="text-red-700 text-sm ml-3"
                  >
                    <small className="block">Mail</small>
                    <strong>https://mail.google.com/mail</strong>
                  </a>
                </li>
              </ul>
            </div>
          ...
          >
            <input
              ...
              className="w-full rounded-md py-2.5 px-4 border text-md outline-[#007bff]"
            />
            <input
              type="email"
              name="email"
